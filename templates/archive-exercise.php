...
<?php if(is_user_logged_in()){
  ...
  <div class="checklist-progress" id="progress-bar">
    <span></span>
  </div>
</div>
...
?>
            ...
            <div class="level-wraper">
                    ...
                    <?php
                    $exerciseLevelOptions = array('A0', 'A1', 'A2', 'B1', 'B2', 'C1', 'C2');

                    if (!empty($exerciseLevelOptions) && is_array($exerciseLevelOptions)) {
                    ?>
                        <div class="filter-options-title">Niveau :</div>
                        <div class="level-options-container" id="level-options">
                            <?php
                            foreach ($exerciseLevelOptions as $option) {
                                $checked = isset($_GET['exercise_level']) && $_GET['exercise_level'] === $option ? 'checked' : '';
                            ?>
                                <div class="level-option">
                                    <div class="check">
                                        <label for="<?php echo $option; ?>">
                                            <input type="radio" id="<?php echo $option; ?>" name="exercise_level" value="<?php echo $option; ?>" <?php echo $checked; ?>>
            ...
            <div class="save-checkbox-wrapper exercise-item__save onlysaved"> 
        ...
        <div class="side-bar-archive-container" id="side-bar-archive">
                ...
                <label class="container-checkbox category" id="prononciation">
                    <input type="checkbox" >
                    <div class="checkmark"></div>
        ...
        <div id="exercises-archive-container" class="container archive-container  ">

        <!-- Exercise posts will be dynamically rendered here -->
        </div>   
        </div>     
</div>         
</main>
